                          ...
                          child: Column(
                            children: [
                              ...
                              AppTextfield(
                                ...
                                if (!RegexUtils.atLeastAnUppercase.hasMatch(value)) {
                                  return 'Password must contain at least one uppercase letter';
                                }
                                if (!RegexUtils.atLeastANumber.hasMatch(value)) {
                                  return 'Password must contain at least one number';
                                }
                                if (!RegexUtils.specialChar.hasMatch(value)) {
                              ...
                              CustomButton(
                               onTap: () {
                                 if(formkey.currentState!.validate()){
                                  bloc.add(RegisterButtonClickedEvent(userName: usernameController.text,useEmail: emailController.text, password: passwordController.text,));
                                 }
                               },
